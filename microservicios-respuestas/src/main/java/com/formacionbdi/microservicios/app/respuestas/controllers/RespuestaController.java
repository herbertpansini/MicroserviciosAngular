...
public class RespuestaController {
    ...
    public ResponseEntity<?> obtenerRespuestasPorAlumnoIdAndExamenId(@PathVariable Long alumnoId, @PathVariable Long examenId) {
        return ResponseEntity.ok(this.respuestaService.findByAlumnoIdAndExamenId(alumnoId, examenId));
    }

    @GetMapping("/alumno/{alumnoId}/examenes-respondidos")
    public ResponseEntity<?> obtenerExamenesIdsConRespuestasByAlumnoId(@PathVariable Long alumnoId) {
